...
class VideoDetailPage extends StatefulWidget {
  ...
  VideoDetailPage({required this.videoUrl});
                        ...
                        children: List.generate(movieList.length, (index) {
                          return Padding(
                            ...
                            child: Column(children: [
                                        ...
                                        Container(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Text(movieList[index]['title'], style:TextStyle(
                                                  fontSize: 15,
                                                  height: 1.3,
                                                  fontWeight: FontWeight.bold,
                                                  color: Colors.white.withOpacity(0.9)
                                                ...
                                                Text(movieList[index]['duration'], style:TextStyle(
                                                    fontSize: 12,
                                                    height: 1.3,
                                                    color: Colors.white.withOpacity(0.5)
                                                ),
                              ...
                              Text(movieList[index]['description'], style: TextStyle(
                                height: 1.4,
                                color: Colors.white.withOpacity(0.5)
                              ),)
                            ]),
